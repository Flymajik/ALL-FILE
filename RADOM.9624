...
for xd in range(10000):
	...
	d='OPPO R7 Build/KTU84P)'
	e=random.randrange(100, 9999)
	f='AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/35.0.1916.138'
	g=random.randrange(1, 9)
	h=random.randrange(1, 4)
	i=random.randrange(1, 4)
	j=random.randrange(1, 4)
	k='Mobile Safari/537.36 T7/7.4 baiduboxapp/8.3.1 (Baidu; P1 4.4.4)NULL'
