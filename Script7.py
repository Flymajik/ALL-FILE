...
os.system("clear")
print("\x1b[1;92m┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;92m┃╔═❲  Only Admin Chekout Api Key 083124289136 ❳")
print("\x1b[1;92m┃╚═════════════════════════════════")
print("\x1b[1;92m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;92m┃╔═❲ List Harga Api Key Tools️ ❳═>")
print("\x1b[1;92m┃║• Api Key Mingguan : 10k")
print("\x1b[1;92m️┃║• Api Key 1 Bulan : 20k")
print("\x1b[1;92m┃║• Api Key 2 Bulan : 30k")
print("\x1b[1;92m┃║• Api Key Pertahun : 50k")
#print("\x1b[1;97m┃║• Upgrade Ke Pro : 200K")️
print("\x1b[1;92m┃╚═════════════════════════════════")
print("\x1b[1;92m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
print("\x1b[1;92m┃╔═❲ Litst Harga Sorce Code️ ❳═>")
print("\x1b[1;92m┃║• Harga File Open code : GK DIJUAL")
print("\x1b[1;92m┃╚═════════════════════════════════")
print("\x1b[1;92m┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")

input("\n\x1b[1;97m╔═❲ MASUKAN APIKEY -> ENTER")
Password = "GKHJ-HSJS-BSHS-TTWH" # --> Data Req Api key --> open_kt(life)("GKHJ-HSJS-BSHS-TTWH")

loop = 'true'
while (loop == 'true'):
    passcode = input("\x1b[1;92m╔═❲Validasi Api Key ? : ")
    if (passcode == Password):
            loop = 'false'
            time.sleep(5.0)
            print("\n \x1b[1;92m╔═❲ Mengecek Api key... ")
            time.sleep(6.0)
            print("\n \x1b[1;92m╔═❲ Api Key Anda Valid ")          
    else:
            exit("\033[91m╔═❲Api Key Anda Expire")        
#-----------------[ IMPORT-MODULE ]-------------------
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r└──{sir}   🌎{x}  {P}{b}{loop}{P}/{u}{len(id)}{P} OK {P}{h}{cp}{P} CP {P}{k}{ok}{x} : {bo}{'{:.0%}'.format(loop/float(len(id)))}{P}  "), 
	sys.stdout.flush()
