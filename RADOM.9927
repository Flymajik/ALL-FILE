...
{P}[•]{B}----------------------------------------------------{P}[•]
{B} |
{P}[•] ADMKN LISESI : Faz 丂卂乃ㄥ乇几Ҝ
{P}[•] WHATSAPP : 083109115523
{P}[•] FACEBOOK : 卩尺ㄖᎶ尺卂爪 匚ㄖᗪ乇""")
def licensi():#line:42
  try :#line:43
    os .system ('clear')
    kontol()
    ...
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      ...
      if len (O000O000OOO000OOO )==0 :#line:55
        ...
        with requests .Session ()as O0O0OO0O0O00OOOO0 :#line:58   #### ISI TOKEN LU DAN   ID LU
          ...
          print (f"{H}[{P}*{H}]{P} Basi :{K} {OOO00OO00O0O0OOOO['expires'].split('T')[0]}");time .sleep (2 );login()#line:61
